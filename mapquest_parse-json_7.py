...
while True:
    ...
    if json_status == 0:
        ...
        print("Kilometers:      " + str("{:.2f}".format((json_data["route"]["distance"])*1.61)))    #Gets distance in kilometers
        print("Fuel Used (Ltr): " + str("{:.2f}".format((json_data["route"]["fuelUsed"])*3.78)))    #Gets amount of fuel used
        print("=============================================")
